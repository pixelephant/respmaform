<?php include("_header.php") ?>
  <section id="content">
    <hgroup>
      <h1>M8 MINI CITY BUS</h1>
      <h2>for the special needs of inner city transportation <span>school project @<a href="http://www.mome.hu">MOME</a></span></h2>
    </hgroup>
    <p id="portfolio-nav">
      <a class="prev" href="#"> <span aria-hidden="true">&laquo;</span> Previous</a>
      <a href="#" class="all">M8 MINI CITY BUS</a>
    ...
    <section id="project">
      ...
      <div class="text">
        ...
        <p>M8 is an admirable bus using technology available today (in five years) that can perfectly fit into city environments. If people <strong>enjoy</strong> riding a bus, they will be more likely to use <strong>public transportation</strong> – and this means a cleaner, quieter, more <strong>livable city</strong>.</p>
      </div>

      <div class="text">
        <h3>MINIMAL IMPACT</h3>
        <p>Thanks to the large reflecting surfaces, the bus <strong>fits into its environment</strong>, while the elegant metal frame makes it <strong>unique and recognizable</strong>.</p>
      </div>
